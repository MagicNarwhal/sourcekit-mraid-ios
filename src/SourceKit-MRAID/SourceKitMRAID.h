...
//  SourceKitMRAID
//
//  Created by Timothy Sanders on 11/14/16.
//

#import <UIKit/UIKit.h>

//! Project version number for SourceKit-MRAID.
FOUNDATION_EXPORT double SourceKit_MRAIDVersionNumber;

//! Project version string for SourceKit-MRAID.
